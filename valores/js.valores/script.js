...
function loadMusic(indexNumb) {
  ...
  musicImg.src = `../valores/assets-valores/capa-album/${allMusic[indexNumb - 1].img}.png`;
  mainAudio.src = `../valores/assets-valores/musicas-valores/${allMusic[indexNumb - 1].src}.mp3`;
  ...
  let liTag =
    ...
    `
        <li li-index="${i + 1}">
          ...
          <audio class="${allMusic[i].src}" src="../valores/assets-valores/musicas-valores/${allMusic[i].src}.mp3"></audio>
