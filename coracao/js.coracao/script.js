...
function loadMusic(indexNumb) {
  ...
  musicImg.src = `../coracao/assets-coracao/capa-album/${allMusic[indexNumb - 1].img}.png`;
  mainAudio.src = `../coracao/assets-coracao/musicas-coracao/${allMusic[indexNumb - 1].src}.mp3`;
  ...
  let liTag =
    ...
    `
        <li li-index="${i + 1}">
          ...
          <audio class="${allMusic[i].src}" src="../coracao/assets-coracao/musicas-coracao/${allMusic[i].src}.mp3"></audio>
