...
function loadMusic(indexNumb) {
  ...
  musicImg.src = `../essa_tal_emocao/assets-emocao/capa-album/${allMusic[indexNumb - 1].img}.png`;
  mainAudio.src = `../essa_tal_emocao/assets-emocao/musicas-emocao/${allMusic[indexNumb - 1].src}.mp3`;
  ...
  let liTag =
    ...
    `
        <li li-index="${i + 1}">
          ...
          <audio class="${allMusic[i].src}" src="../essa_tal_emocao/assets-emocao/musicas-emocao/${allMusic[i].src}.mp3"></audio>
