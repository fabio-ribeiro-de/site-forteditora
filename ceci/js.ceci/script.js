...
function loadMusic(indexNumb) {
  ...
  musicImg.src = `../ceci/assets-ceci/capa-album/${allMusic[indexNumb - 1].img}.png`;
  mainAudio.src = `../ceci/assets-ceci/musicas-ceci/${allMusic[indexNumb - 1].src}.mp3`;
  ...
  let liTag =
    ...
    `
        <li li-index="${i + 1}">
          ...
          <audio class="${allMusic[i].src}" src="../ceci/assets-ceci/musicas-ceci/${allMusic[i].src}.mp3"></audio>
