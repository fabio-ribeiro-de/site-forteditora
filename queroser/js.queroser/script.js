...
function loadMusic(indexNumb) {
  ...
  musicImg.src = `../queroser/assets-queroser/capa-album/${allMusic[indexNumb - 1].img}.png`;
  mainAudio.src = `../queroser/assets-queroser/musicas-queroser/${allMusic[indexNumb - 1].src}.mp3`;
  ...
  let liTag =
    ...
    `
        <li li-index="${i + 1}">
          ...
          <audio class="${allMusic[i].src}" src="../queroser/assets-queroser/musicas-queroser/${allMusic[i].src}.mp3"></audio>
